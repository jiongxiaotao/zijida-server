...
public class FRSignDao {
     ...
     * @throws Exception
     */
    public static String sign(long appId, String secretId, String secretKey, String bucketName,
    ...
    public static String Base64Encode(byte[] binaryData) {
        String encodedstr ="";// Base64.encodeToString(binaryData,false);
        return encodedstr;
    }
